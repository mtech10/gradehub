...
function CoursesSkeleton() {
  // Mock dummy links structure for the QuickLinks skeleton
  const skeletonLinks = [
    {
      title: "...",
      description: "...",
  ...
  // Mock dummy stats structure for CourseStatistics skeleton
  ...
  return (
    <div className="space-y-8 animate-pulse">
      ...
      {/* Main Content Layout Skeletons */}
      <section className="grid gap-8 xl:grid-cols-12">
        {/* Left Column: Course Accordions Skeletons */}
